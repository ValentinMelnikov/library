...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def test_logged_in_uses_correct_template(self):
        ...
        self.assertTemplateUsed(resp, 'catalog/library_worker_templates/bookinstance_list_borrowed_user.html')
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_uses_correct_template(self):
        ...
        self.assertTemplateUsed(resp, 'catalog/library_worker_templates/book_renew_librarian.html')
